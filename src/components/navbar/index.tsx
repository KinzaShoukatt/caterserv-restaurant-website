...
const Navbar = () => {
  ...
  return (
    <>
      ...
      transform transition-all duration-600 origin-top
      ${dropDown ? "scale-y-100 opacity-100" : "scale-y-0 opacity-0"}`}
        ...
        <div className="flex gap-5 items-center font-sans text-lg font-semibold">
          ...
          <div className="bg-[#D4A762] text-lg py-1.5 px-5.5 rounded-3xl cursor- transition-all duration-500 hover:bg-black hover:text-[#D4A762]">
            Book Now
          </div>
        </div>
      </div>
